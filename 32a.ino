...
void loop() {
  int dim_brt_main = digitalRead(0);
  int dim_brt_com1 = digitalRead(1);
  int dim_brt_com2 = digitalRead(23);
  int dim_brt_vor = digitalRead(22);
  int dim_brt_MB = digitalRead(21);
  int dim_brt_tacan = digitalRead(20);
  voltage = analogRead(Vpwm);
  voltage = voltage *1.054;
